...
class SemanticCheckerTests {
 ...
 @Test
  ...
  @Test
  void canSetVarToAnotherArray() {
    var p =
      """
      void main() {
      var me: [int] = new int[10]
      me[0] = 2
      var you: [int] = me
      }
      """;
  ...
  @Test
  void callingFunctionThatDoesNotExist() {
    var p =
      """
      void main() {
      var x: int = getInt()
